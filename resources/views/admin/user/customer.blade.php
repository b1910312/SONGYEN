                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-bold">Danh sách khách hàng
                                        ...
                                        @foreach ($Users as $blg)
                                                ...
                                                @if ($cus->email == $blg->email)
                                                    <tr>
                                                        ...
                                                        <td class="col-lg-1">
                                                            ...
                                                            <a href="{{ route('admin.customer.update.role', ['email' => $blg->email]) }}"
                                            ...
                                            <div class="modal fade" id="model{{ $blg->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.customer.update', ['id' => $blg->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="container-fluid">
                                            ...
                                            <div class="modal fade" id="image{{ $blg->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Cạp nhật ảnh đại diện khách hàng</h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        ...
                                                        <form
                                                            action="{{ route('admin.customer.update.image', ['id' => $blg->id]) }}"
