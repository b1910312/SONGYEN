                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-bold">Danh sách sự kiện
                                    <a href="{{ route('admin.event.new') }}" class="btn btn-primary">+</a>
                                </h3>
                                ...
                                <table class="table table-head-fixed" id="myTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-lg-2">Nội dung tóm tắt</th>
                                            <th class="col-lg-2">Nội dung chi tiết</th>
                                            <th class="col-lg-1">Địa điểm</th>
                                            <th class="col-lg-1">Ngày bắt đầu</th>
                                            <th class="col-lg-1">Ngày kết thúc</th>
                                    ...
                                    <tbody>
                                        @foreach ($events as $blg)
                                            <tr>
                                                <td class="col-lg-1">{{ $blg->id }}</td>
                                                <td class="col-lg-1">{{ $blg->name }}</td>
                                                <td class="col-lg-2">{{ $blg->content }}</td>
                                                <td class="col-lg-2"><div style="overflow-y: auto; max-height: 300px;">{!!$blg->content_details!!}</div></td>
                                                <td class="col-lg-1">{{ $blg->place }}</td>
                                                <td class="col-lg-1">{{ $blg->time_start }}</td>
                                                <td class="col-lg-1">{{ $blg->time_end }}</td>
                                                ...
                                                <td class="col-lg-1">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="{{ route('admin.updatethumbnail', ['post'=>$blg->id, 'type'=> '2']) }}" method="POST" enctype="multipart/form-data">
                                                                        @csrf
                                                                        <div class="form-group">
                                                                            <label for="">Thumbnail hiện tại</label> <br>
                                                                            @foreach ($ThumbNails as $item)
                                                                                @if ($item->post == $blg->id && $item->typepost == 2)
                                                    ...
                                                    <a href="{{ route('admin.event.edit', ['id'=>$blg->id]) }}" class="btn btn-warning"><i
                                                            class="fa fa-wrench"></i></a>
                                                    <a href="{{ route('admin.event.delete', ['id'=>$blg->id]) }}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
