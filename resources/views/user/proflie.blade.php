            ...
            <div class="row" style="padding: 30px 30px">
                ...
                <div class="col-lg-9 card border border-warning d-flex" style="padding: 30px 30px">
                            ...
                            <div class="container">
                                <form action="{{ route('admin.customer.update.image', ['id' => $Infor->id]) }}"
                                    ...
                                    <div class="form-group-lg">
                                        <label class="col-form-label-lg" for="">Ảnh đại diện</label> <br>
                    ...
                    <div class="card" style="padding: 20px 20px;  margin: 10px 10px;">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <form action="{{ route('admin.customer.update', ['id' => $Infor->id]) }}" method="POST">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col">
                                            ...
                                            <select class="form-control" name="sex" id="sex">
                                                <option value="0"
                                                    @if ($Infor->sex == 0) {{ _('selected') }} @endif>Nữ
                                                </option>
                                                <option value="1"
                                                    @if ($Infor->sex == 1) {{ _('selected') }} @endif>Nam
                                                </option>
                                            </select>
                                        </div>
                                    </div>
